...
parser = argparse.ArgumentParser(
    description="Create a plot from reconstruction save or autosave."
)
...
filename = "sample.ptyr"  # args.ptyrfile
template = "default"  # args.layout
save = "result.png"  # args.imfile
